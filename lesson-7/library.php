...
define("SMTP_UNAME", "nguyenhuuanh5784@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "Delnghira123"); //Password for SMTP authentication
